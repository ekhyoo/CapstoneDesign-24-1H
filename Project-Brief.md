...
| (9) 데모 내용 | 1. 선호 장르와 배경 입력을 바탕으로 게임 세계관 생성<br>2. 플레이어 캐릭터의 스탯(능력치) 설정<br>3. 게임 기본 정보(세계관, 인트로, 목표, 이벤트, npc, 장소) 생성<br>4. 게임 인트로 스크립트 출력<br>5. NPC와의 대화 상호작용<br>6.주사위 이벤트 진행 - 성공 / 실패 시나리오 |
| (10) 기타 |  |
