...
| (9) 데모 내용 | 1. 수화 기본 학습 scene : 1) 플레이어 움직임 구현 <br>2) 수화 인식 및 입력 받은 수화와 일치하는 오브젝트 파괴 <br>3)NPC 이동 및 대사창 구현 <br>2.수화 심화 학습 scene: 1) 오브젝트의 무작위 배치와 플레이어 캐릭터로의 이동 <br>2) 플레이어 캐릭터가 오브젝트에 닿을 시 hp 감소 <br>3)조건에 따른 엔딩화면 scene으로의 이동  |
| (10) 기타 |  |
